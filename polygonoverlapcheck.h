#ifndef POLYGONOVERLAPCHECK_H
#define POLYGONOVERLAPCHECK_H

#include "check.h"
#include "checkerror.h"

class PolygonOverlapCheckError : public CheckError
{
public:
     ...
     */
    PolygonOverlapCheckError(const Check *check,
...
class PolygonOverlapCheck : public Check
{
    Q_DECLARE_TR_FUNCTIONS(PolygonOverlapCheck)
public:
    /**
     ...
     */
    PolygonOverlapCheck(const CheckContext *context, const QVariantMap &configuration);
