...
public:
    ...
    static QString factoryDescription() { return QStringLiteral("非凸包"); }
...
private:
    bool checkConvexHull(const QgsAbstractGeometry *geom) const;
    ...
    bool selfIntersect(const QgsAbstractGeometry *geom, int iPart) const;
};
