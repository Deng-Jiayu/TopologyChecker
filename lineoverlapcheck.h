#ifndef LINEOVERLAPCHECK_H
#define LINEOVERLAPCHECK_H

#include "check.h"
#include "checkerror.h"

class LineOverlapCheckError : public CheckError
{
public:
     ...
     */
    LineOverlapCheckError(const Check *check,
...
class LineOverlapCheck : public Check
{
    Q_DECLARE_TR_FUNCTIONS(LineOverlapCheck)
public:
    /**
    ...
    LineOverlapCheck(const CheckContext *context, const QVariantMap &configuration);
