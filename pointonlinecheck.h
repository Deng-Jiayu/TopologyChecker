#ifndef POINTONLINECHECK_H
#define POINTONLINECHECK_H

#include "check.h"

class PointOnLineCheck : public Check
{
    Q_DECLARE_TR_FUNCTIONS(PointOnLineCheck)
public:
    PointOnLineCheck(CheckContext *context, const QVariantMap &configuration)
    ...
    static QString factoryDescription() { return QStringLiteral("点未被线覆盖"); }
    QString description() const override { return factoryDescription(); }
    static QString factoryId() { return QStringLiteral("PointOnLineCheck"); }
