#ifndef DUPLICATENODECHECK_H
#define DUPLICATENODECHECK_H

#include "check.h"

class DuplicateNodeCheck : public Check
{
...
public:
    ...
    static QString factoryDescription() { return QStringLiteral("重复节点"); }
    QString description() const override { return factoryDescription(); }
    static QString factoryId() { return QStringLiteral("DuplicateNodeCheck"); }
