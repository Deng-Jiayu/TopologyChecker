...
TopologyCheckerGui::TopologyCheckerGui( QWidget* parent, Qt::WindowFlags fl )
    : QDialog( parent, fl )
{
  setupUi( this );
  ...
  QString format( "<html><body><h3>%1</h3>%2<h3>%3</h3>%4<p><a href=http://qgis.org/api>"
                  ...
                  "<h4>topologychecker.h, topologychecker.cpp</h4>%12"
                  "<h4>topologycheckergui.ui</h4>%13"
                  "<h4>topologycheckergui.cpp, topologycheckergui.h</h4>%14"
                  "<h4>topologychecker.qrc</h4>%15"
                  "<h4>topologychecker.png</h4>%16"
                  "<h4>README</h4>%17"
...
TopologyCheckerGui::~TopologyCheckerGui()
{
}

void TopologyCheckerGui::on_buttonBox_accepted()
{
  //close the dialog
  accept();
}

void TopologyCheckerGui::on_buttonBox_rejected()
{
  reject();
}

void TopologyCheckerGui::on_buttonBox_helpRequested()
{
}
